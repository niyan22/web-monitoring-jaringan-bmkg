...
<div class="container-fluid">
    <div class="mb-4">
        <h2 class="fw-bold mb-1">Tambah Data System</h2>
        <p class="text-muted">Masukkan data metrik sistem terbaru</p>
    </div>
            ...
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    <div class="small text-muted">
                        <p><strong>CPU Load:</strong> Persentase penggunaan CPU (0-100%)</p>
                        <p><strong>Processor:</strong> Informasi detail processor</p>
                        <p><strong>Memory:</strong> Penggunaan memori dalam GB</p>
                        <p><strong>Disk:</strong> Penggunaan storage dalam GB</p>
                    </div>
                </div>
            </div>
        </div>
